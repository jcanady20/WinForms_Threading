...
namespace WinForms_Threading.Controls
{
	public partial class LoadingCircle : Control
	{
		...
		[System.ComponentModel.Category("LoadingCircle"),
		 System.ComponentModel.Description("Quickly sets the style to one of these presets, or a custom style if desired"),
		 System.ComponentModel.DefaultValue(typeof(StylePresets), "Custom")]
		...
		public LoadingCircle()
		{
			...
			m_Timer.Elapsed += new System.Timers.ElapsedEventHandler(aTimer_Tick);
			ActiveTimer();
		...
		{
			using (SolidBrush brsh = new SolidBrush(_objColor))
			{
				using (Pen objPen = new Pen(brsh, _intLineThickness))
				{
